  ...
  return (
    <AdminLayout>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="graph">
          <p className="mb-4 section-title">Top {value > 0 || "-"} Authors</p>
          <Bar
        ...
        <div className="graph">
          <p className="mb-4 section-title">Top {value > 0 || "-"} Genres</p>
          <Bar
        ...
        <div className="my-12 graph">
          <p className="mb-4 section-title">Top {value > 0 || "-"} Keywords</p>
          <Bar
